...
logfilenm = r"remarksfieldupdate.log"
...
import logging
logger = logging.getLogger('lnclupdateremarks')
...
logger.info("lane closure remarks field update begins at {} ".format(tbeg))
print("lane closure remarks field update begins at {} ".format(tbeg))
...
fld0 = "Remarks"
val0 = "" #dot_bkawakami" # "dot_mmorita" # "dot_mdelosreyes" # "dot_mluckfield" #"dot_srombaoa" # "dot_kakazawa" # "dot_rtamai" # "dot_jyago" # "dot_dtanabe" #  "dot_mdelosreyes" #"dot_rtamai" # 'dot_kmurata'
val1 =  "" #"dot_mmorita" # "dot_bmaeda" #"dot_mluckfield" #"dot_srombaoa" # "dot_kakazawa" # "dot_achung" # "dot_gpang"  # "dot_wrapisura" # "dot_kakazawa" #  "dot_gebelleau"
fld1 = "DirPRemarks"
qryStr0 = qryStr0 = "{} like '' and {} not like '' ".format(fld0,fld1)
...
if len(lnclqry)>0:
    ...
    try:
        val1 =  "DirPRemarks" #"dot_mmorita" # "dot_bmaeda" #"dot_mluckfield" #"dot_srombaoa" # "dot_kakazawa" # "dot_achung" # "dot_gpang"  # "dot_wrapisura" # "dot_kakazawa" #  "dot_gebelleau"
        fld1 = "Remarks"
        ...
        qryStr1 = qryStr0  # "{} = {} ".format(fld1,val1 ) # like 'dot_zwu'".format(fld0,val0,fld1,val1 ) # 'dot_kmurata')
        resultupd1 = wmlnclyrsects.calculate(where=qryStr0,calc_expression={"field" : fld1 , "sqlExpression" : val1})
        print (" Update result {} for  {} ".format (resultupd1,expn1))
        logger.info (" Update result {} for  {} ".format (resultupd1,expn1))
    
    except Exception as e:
        print("Couldn't update {} features with query string {}. \n Error mesage {}".format(lnclhdrnm,qryStr0,str(e)))
        logger.info("Couldn't update {} features with query string {}. \n Error mesage {}".format(lnclhdrnm,qryStr0,str(e)))

print (" End lane closure layer {} \n processed  {} features with query {} ".format (lnclhdrnm,len(lnclqry),qryStr0))
logger.info (" End lane closure layer {} \n processed  {} features with query {} ".format (lnclhdrnm,len(lnclqry),qryStr0))
