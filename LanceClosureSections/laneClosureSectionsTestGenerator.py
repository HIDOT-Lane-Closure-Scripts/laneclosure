...
lnclSrcFSTitle = 'LaneClosureTest' # arcpy.GetParameter(0) 
itypelnclsrc="Feature Service" # "Feature Layer" # "Service Definition"
lnclhdrnm = 'LaneClosureTest'
lnclchdnm = 'Location_repeat'

fsectWebMapTitle = 'Lane_Closure_Test_WFL' # arcpy.GetParameter(0) #  'e9a9bcb9fad34f8280321e946e207378'
itypeFS="Feature Service" # "Feature Layer" # "Service Definition"
wmlnclyrptsnm = 'Lane_Closure_Begin_and_End_Points_Test'
wmlnclyrsectsnm = 'Lane_Closure_Sections_Test'

midptfstitle = 'Lane Closure Test Mid Point Features'
midptlyrnm = 'Lane_Closure_Test_Mid_Point_Features'
